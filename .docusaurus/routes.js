...
{
  path: '/blog',
  component: ComponentCreator('/blog','7ff'),
  exact: true,
},
{
  path: '/blog/hello-world',
  component: ComponentCreator('/blog/hello-world','af4'),
  exact: true,
},
{
  path: '/blog/hola',
  component: ComponentCreator('/blog/hola','2c8'),
  exact: true,
},
{
  path: '/blog/tags',
  component: ComponentCreator('/blog/tags','1fb'),
  exact: true,
},
{
  path: '/blog/tags/docusaurus',
  component: ComponentCreator('/blog/tags/docusaurus','f2d'),
  exact: true,
},
{
  path: '/blog/tags/facebook',
  component: ComponentCreator('/blog/tags/facebook','7dc'),
  exact: true,
},
{
  path: '/blog/tags/hello',
  component: ComponentCreator('/blog/tags/hello','808'),
  exact: true,
},
{
  path: '/blog/tags/hola',
  component: ComponentCreator('/blog/tags/hola','0b4'),
  exact: true,
},
{
  path: '/blog/welcome',
  component: ComponentCreator('/blog/welcome','c31'),
  exact: true,
},
{
  path: '/markdown-page',
